...
const Home = () => {
    ...
    const checkoutHandler = async (amount) => {
        ...
        const {data:{key}} = await axios.get('http://localhost:4002/api/getkey')
        ...
        <>
            <Box>
                <Stack direction={['column', 'row']}>
                    ...
                    <Card amount={60} img={'https://images.unsplash.com/photo-1592853625511-ad0edcc69c07?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fG1hY2hpbmV8ZW58MHx8MHx8fDA%3D'} checkoutHandler={checkoutHandler} />
                </Stack>
            </Box>
        </>
    )
